...
public class RetrieveHistoryUseCaseImpl implements RetrieveHistoryUseCase {
    ...
    @Override
    public Page<Transaction> execute(final Long walletId, final String initialDate, final String finalDate) {
        ...
        return gateway.execute(walletId, initialDateParsed, finalDateParsed);
    }
}
